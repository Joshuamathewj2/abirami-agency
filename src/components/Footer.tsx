            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-300 text-sm">Madavaram Red Hills Rd, Kilburn Nagar,<br />Madhavaram, Chennai - 600060</span>
                </li>
                <li className="flex flex-col gap-2">
                  <div className="flex items-center gap-3">
                    ...
                    <a href="tel:8610710434" className="text-gray-300 hover:text-primary-light text-sm transition-colors">+91 86107 10434</a>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-primary-light shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                    <a href="tel:7200377455" className="text-gray-300 hover:text-primary-light text-sm transition-colors">+91 72003 77455</a>
                  </div>
                </li>
                ...
                <li className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-primary-light shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                  <span className="text-gray-300 text-sm">Mon – Sat: 9:00 AM – 8:00 PM</span>
                </li>
              </ul>
            </div>
          </div>
